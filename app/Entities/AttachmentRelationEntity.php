...
#[OA\Schema(schema: 'AttachmentRelationEntity')]
class AttachmentRelationEntity implements \JsonSerializable
{
    use HasSerializableAttributes;

    public const string getId = 'id'; // ID

    public const string getAttachmentId = 'attachment_id'; // 附件ID

    public const string getContentId = 'content_id'; // 关联的内容ID

    public const string getFieldKey = 'field_key'; // 关联到内容的哪个字段（如：封面图、详情图集）

    public const string getSort = 'sort'; // 在该内容下的排序

...
#[OA\Schema(schema: 'AdPositionQueryResponse')]
class AdPositionQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AdPositionResponse::class))]
    private array $data;

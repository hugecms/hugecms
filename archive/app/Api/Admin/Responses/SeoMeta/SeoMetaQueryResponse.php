...
namespace App\Api\Admin\Responses\SeoMeta;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SeoMetaQueryResponse')]
class SeoMetaQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SeoMetaResponse::class))]
    private array $data;

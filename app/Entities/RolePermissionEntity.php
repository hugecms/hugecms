...
class RolePermissionEntity implements \JsonSerializable
{
    ...
    public const string getPermissionId = 'permission_id'; // 权限ID

    public const string getIsDenied = 'is_denied'; // 0=允许，1=拒绝（拒绝优先，覆盖性授权）

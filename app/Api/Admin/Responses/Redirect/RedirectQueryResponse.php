...
#[OA\Schema(schema: 'RedirectQueryResponse')]
class RedirectQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: RedirectResponse::class))]
    private array $data;

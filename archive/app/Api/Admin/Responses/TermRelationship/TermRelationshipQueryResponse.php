...
namespace App\Api\Admin\Responses\TermRelationship;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'TermRelationshipQueryResponse')]
class TermRelationshipQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: TermRelationshipResponse::class))]
    private array $data;

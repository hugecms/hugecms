...
namespace App\Domains\Delivery\Responses\Delivery;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'DeliveryQueryResponse')]
class DeliveryQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: DeliveryResponse::class))]
    private array $data;

...
use App\Domains\Comment\Entities\CommentEntity;
use App\Domains\Comment\Services\CommentService;
use App\Domains\Comment\Requests\Comment\CommentCreateRequest;
use App\Domains\Comment\Requests\Comment\CommentDestroyRequest;
use App\Domains\Comment\Requests\Comment\CommentQueryRequest;
use App\Domains\Comment\Requests\Comment\CommentUpdateRequest;
use App\Domains\Comment\Responses\Comment\CommentDestroyResponse;
use App\Domains\Comment\Responses\Comment\CommentQueryResponse;
use App\Domains\Comment\Responses\Comment\CommentResponse;
...
class CommentController extends BaseController
{
    ...
    #[OA\Post(path: '/comment/search', summary: '查询列表接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    #[OA\Post(path: '/comment/store', summary: '新增接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    #[OA\Get(path: '/comment/show', summary: '获取详情接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    ...
    #[OA\Put(path: '/comment/update', summary: '更新接口', security: [['bearerAuth' => []]], tags: ['模块'])]
    #[OA\Parameter(name: 'id', description: 'ID', in: 'query', required: true, example: 1)]
    ...
    #[OA\Post(path: '/comment/destroy', summary: '删除接口', security: [['bearerAuth' => []]], tags: ['模块'])]

...
#[OA\Schema(schema: 'DataArticleEntity')]
class DataArticleEntity implements \JsonSerializable
{
    use HasSerializableAttributes;

    public const string getId = 'id'; // ID

    public const string getContentId = 'content_id'; // 关联内容主表ID（一对一）

    public const string getField1 = 'field_1'; // 文章摘要（text）

    public const string getField2 = 'field_2'; // 正文内容（rich_text）

    public const string getField3 = 'field_3'; // 封面图，存附件ID或URL（image）

    public const string getExtra = '_extra'; // 预留JSON扩展字段（未建模数据兜底）

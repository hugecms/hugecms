...
#[OA\Schema(schema: 'ContentRevisionEntity')]
class ContentRevisionEntity implements \JsonSerializable
{
    ...
    public const string getAuthorId = 'author_id'; // 修改人

    public const string getRevisionData = 'revision_data'; // 修改时的全量数据快照（JSON）

    public const string getRemark = 'remark'; // 修改备注

    public const string getCreatedAt = 'created_at'; // 修订时间

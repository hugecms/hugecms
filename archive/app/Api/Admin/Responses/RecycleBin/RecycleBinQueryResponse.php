...
#[OA\Schema(schema: 'RecycleBinQueryResponse')]
class RecycleBinQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: RecycleBinResponse::class))]
    private array $data;

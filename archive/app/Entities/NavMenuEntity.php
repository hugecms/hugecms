...
#[OA\Schema(schema: 'NavMenuEntity')]
class NavMenuEntity implements \JsonSerializable
{
    use HasSerializableAttributes;

    public const string getId = 'id'; // ID

    public const string getName = 'name'; // 菜单名称（如：主导航）

    public const string getAlias = 'alias'; // 菜单标识（如：main_nav）

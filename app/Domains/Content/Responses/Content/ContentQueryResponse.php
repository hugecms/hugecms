...
namespace App\Domains\Content\Responses\Content;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'ContentQueryResponse')]
class ContentQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ContentResponse::class))]
    private array $data;

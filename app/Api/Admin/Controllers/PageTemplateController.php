...
class PageTemplateController extends BaseController
{
    ...
    public function search(PageTemplateQueryRequest $queryRequest): JsonResponse
    {
        ...
        try {
            $condition = [];
            if (! empty($requestData[PageTemplateQueryRequest::getKeyword])) {
                $condition[] = [PageTemplateEntity::getTemplateName, 'like', '%'.$requestData[PageTemplateQueryRequest::getKeyword].'%'];
            }

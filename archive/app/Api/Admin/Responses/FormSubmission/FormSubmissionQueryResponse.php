...
#[OA\Schema(schema: 'FormSubmissionQueryResponse')]
class FormSubmissionQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: FormSubmissionResponse::class))]
    private array $data;

...
namespace App\Domains\Comment\Responses\Comment;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'CommentQueryResponse')]
class CommentQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: CommentResponse::class))]
    private array $data;

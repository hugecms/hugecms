...
#[OA\Schema(schema: 'AttachmentEntity')]
class AttachmentEntity implements \JsonSerializable
{
    use HasSerializableAttributes;

    public const string getId = 'id'; // ID

    public const string getUploaderId = 'uploader_id'; // 上传者ID

    public const string getFileName = 'file_name'; // 原始文件名

    public const string getFilePath = 'file_path'; // 物理存储相对路径

    public const string getStorageDriver = 'storage_driver'; // 存储驱动：local/oss/cos/s3

    public const string getStorageBucket = 'storage_bucket'; // 存储桶名称（仅云存储有效）

    public const string getCdnUrl = 'cdn_url'; // CDN加速访问URL

    public const string getFileSize = 'file_size'; // 文件大小（字节）

    public const string getMimeType = 'mime_type'; // MIME类型（如：image/jpeg）

    public const string getWidth = 'width'; // 图片宽度（仅图片）

    public const string getHeight = 'height'; // 图片高度（仅图片）

    public const string getAltText = 'alt_text'; // SEO替代文本

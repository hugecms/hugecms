...
#[OA\Schema(schema: 'NavItemQueryResponse')]
class NavItemQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: NavItemResponse::class))]
    private array $data;

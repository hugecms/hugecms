...
<div class="panel">
    <div class="panel-heading">
        <div class="pull-right">
            <a href="{{ route('admin.short-links.index') }}" class="btn btn-default btn-sm">返回短链列表</a>
        </div>
...
<script>
    adminApi.post('/api/admin/shortLinkClick/search', {page: 1, pageSize: 30, short_link_id: {{ $id }}}).then(res => {
        ...
        if (!rows.length) { tbody.innerHTML = '<tr><td colspan="5" class="text-muted">暂无点击</td></tr>'; return; }

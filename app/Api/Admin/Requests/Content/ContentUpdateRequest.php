...
class ContentUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            self::getVisibility => 'required',
            self::getPassword => 'required',
            self::getViews => 'required',
            self::getCommentCount => 'required',
            self::getSort => 'required',
            self::getIsTop => 'required',
            self::getPublishedAt => 'required',
            self::getAuditStatus => 'required',
            self::getAuditRemark => 'required',
            self::getAuditorId => 'required',
            self::getAuditedAt => 'required',
        ];
    }

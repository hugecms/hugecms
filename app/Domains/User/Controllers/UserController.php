...
use App\Domains\User\Requests\User\UserUpdateRequest;
...
class UserController extends BaseController
{
    ...
    public function store(UserCreateRequest $createRequest): JsonResponse
    {
        ...
        try {
            ...
            if ($this->userService->save($input->toEntity())) {
                DB::commit();
    ...
    public function update(UserUpdateRequest $updateRequest): JsonResponse
    {
        ...
        try {
            ...
            $this->userService->updateById($input->toEntity(), $id);
    ...
    public function destroy(UserDestroyRequest $destroyRequest): JsonResponse
    {
        ...
        DB::beginTransaction();
        try {
            if ($this->userService->removeByIds($requestData['ids'])) {
                DB::commit();

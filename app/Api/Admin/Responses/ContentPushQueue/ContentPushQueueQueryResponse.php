...
#[OA\Schema(schema: 'ContentPushQueueQueryResponse')]
class ContentPushQueueQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ContentPushQueueResponse::class))]
    private array $data;

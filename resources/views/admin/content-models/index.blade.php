...
<div class="panel">
    ...
    <div class="panel-heading">
        <div class="pull-right">
            <a href="{{ route('admin.content-models.create') }}" class="btn bg-primary-500 text-white">新增模型</a>
        </div>
        <strong>内容模型</strong>
    </div>
    ...
    <form class="filter-bar" id="filter-form">
        <div class="form-group">
            <label>关键词</label>
            <input type="text" class="form-control" id="f-keyword" placeholder="模型名称 / 别名" style="width:200px">
        </div>
...
<script>
    ...
    function load(page = 1, pageSize = adminApi.pageSize) {
        currentPage = page;
        adminApi.post('/api/admin/contentModel/search', {page, pageSize, ...collectFilters()}).then(res => {
    ...
    function destroyRow(id) {
        ...
        adminApi.post('/api/admin/contentModel/destroy', {ids: [id]}).then(() => load(currentPage));
    }
</script>
@endpush

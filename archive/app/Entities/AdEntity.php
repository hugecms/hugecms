...
class AdEntity implements \JsonSerializable
{
    use HasSerializableAttributes;

    public const string getId = 'id'; // ID

    public const string getPositionId = 'position_id'; // 所属广告位ID

    public const string getTitle = 'title'; // 广告标题

    public const string getAdType = 'ad_type'; // 广告类型：image/text/video/html

    public const string getCoverImage = 'cover_image'; // 广告图片/视频封面URL

    public const string getContent = 'content'; // 广告内容（纯文本或HTML代码）

    public const string getLinkUrl = 'link_url'; // 广告跳转链接

    public const string getLinkTarget = 'link_target'; // 打开方式：0本窗口，1新窗口

    public const string getSort = 'sort'; // 展示排序（数值越小越靠前）

    public const string getStartTime = 'start_time'; // 投放开始时间（NULL表示立即开始）

    public const string getEndTime = 'end_time'; // 投放结束时间（NULL表示永久，过期由时间判断）

    public const string getDisplayLimit = 'display_limit'; // 展示次数上限（0不限）

    public const string getClickLimit = 'click_limit'; // 点击次数上限（0不限）

    public const string getDisplayCount = 'display_count'; // 实际展示次数

    public const string getClickCount = 'click_count'; // 实际点击次数

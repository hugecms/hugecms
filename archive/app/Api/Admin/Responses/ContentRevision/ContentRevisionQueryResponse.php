...
#[OA\Schema(schema: 'ContentRevisionQueryResponse')]
class ContentRevisionQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ContentRevisionResponse::class))]
    private array $data;

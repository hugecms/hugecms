...
namespace App\Api\Admin\Responses\StatisticsDaily;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'StatisticsDailyQueryResponse')]
class StatisticsDailyQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: StatisticsDailyResponse::class))]
    private array $data;

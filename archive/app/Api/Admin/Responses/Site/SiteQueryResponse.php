...
namespace App\Api\Admin\Responses\Site;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'SiteQueryResponse')]
class SiteQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: SiteResponse::class))]
    private array $data;

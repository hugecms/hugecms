...
class AdPositionEntity implements \JsonSerializable
{
    use HasSerializableAttributes;

    public const string getId = 'id'; // ID

    public const string getName = 'name'; // 广告位名称（如：首页Banner）

    public const string getCode = 'code'; // 广告位代码（如：home_banner，模板调用用）

    public const string getWidth = 'width'; // 建议宽度（像素）

    public const string getHeight = 'height'; // 建议高度（像素）

    public const string getAdType = 'ad_type'; // 支持的广告类型：image/text/video/html

    public const string getMaxCount = 'max_count'; // 该广告位最多展示广告数量

    public const string getDescription = 'description'; // 广告位描述

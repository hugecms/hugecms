...
#[OA\Schema(schema: 'NavMenuQueryResponse')]
class NavMenuQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: NavMenuResponse::class))]
    private array $data;

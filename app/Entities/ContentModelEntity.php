...
class ContentModelEntity implements \JsonSerializable
{
    use HasSerializableAttributes;

    public const string getId = 'id'; // ID

    public const string getName = 'name'; // 模型名称（显示用，如：招聘信息）
    ...
    public const string getIsSystem = 'is_system'; // 是否系统内置：1是（不可删除），0否

    public const string getIsCommentable = 'is_commentable'; // 是否允许评论：1是，0否（模型级开关；全站开关见 options.comment_config，两者同时生效取与）

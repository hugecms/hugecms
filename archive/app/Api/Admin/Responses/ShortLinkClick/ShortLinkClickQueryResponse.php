...
namespace App\Api\Admin\Responses\ShortLinkClick;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'ShortLinkClickQueryResponse')]
class ShortLinkClickQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ShortLinkClickResponse::class))]
    private array $data;

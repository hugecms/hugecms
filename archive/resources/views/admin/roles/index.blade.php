...
<div class="panel">
    ...
    <form class="filter-bar" id="filter-form">
        <div class="form-group">
            <label>关键词</label>
            <input type="text" class="form-control" id="f-keyword" placeholder="角色名称" style="width:200px">
        </div>
...
<script>
    ...
    function load(page = 1, pageSize = adminApi.pageSize) {
        currentPage = page;
        adminApi.post('/api/admin/role/search', {page, pageSize, ...collectFilters()}).then(res => {
    ...
    function destroyRow(id) {
        ...
        adminApi.post('/api/admin/role/destroy', {ids: [id]}).then(() => load(currentPage));
    }
</script>
@endpush

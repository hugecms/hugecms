...
#[OA\Schema(schema: 'ContentModelQueryResponse')]
class ContentModelQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ContentModelResponse::class))]
    private array $data;

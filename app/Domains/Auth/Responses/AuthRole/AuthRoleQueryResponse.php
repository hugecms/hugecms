...
namespace App\Domains\Auth\Responses\AuthRole;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'AuthRoleQueryResponse')]
class AuthRoleQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AuthRoleResponse::class))]
    private array $data;

...
#[OA\Schema(schema: 'ModelFieldQueryResponse')]
class ModelFieldQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: ModelFieldResponse::class))]
    private array $data;

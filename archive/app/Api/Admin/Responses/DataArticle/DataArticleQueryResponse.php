...
#[OA\Schema(schema: 'DataArticleQueryResponse')]
class DataArticleQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: DataArticleResponse::class))]
    private array $data;

...
namespace App\Api\Admin\Responses\FormTemplate;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'FormTemplateQueryResponse')]
class FormTemplateQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: FormTemplateResponse::class))]
    private array $data;

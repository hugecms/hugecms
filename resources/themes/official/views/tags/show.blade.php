...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
    <div class="border-b border-[#f0f0f0] dark:border-[#303030] pb-6 space-y-1.5">
        <span class="antd-tag"># 标签归档</span>
        <h1 class="text-2xl font-bold text-slate-900 dark:text-white">{{ $tag->name }}</h1>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        @empty
            <div class="col-span-full py-16 text-center text-xs text-slate-400">该标签下暂无已发布的文章</div>
        @endforelse
    </div>
</div>
@endsection

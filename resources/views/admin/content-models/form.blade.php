...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <form id="field-form">
            <div class="row">
                ...
                <div class="col-md-1 form-group">
                    <label class="checkbox-inline" style="padding-top:7px"><input type="checkbox" id="f-required"> 必填</label>
                </div>
                <div class="col-md-1 form-group">
        ...
        <table class="table table-hover">
            ...
            <tbody id="fields-tbody"><tr><td colspan="8" class="text-muted">加载中…</td></tr></tbody>
        </table>
        @endif
    </div>
</div>
    ...
    function loadFields() {
        adminApi.post('/api/admin/modelField/search', {page: 1, pageSize: 200, model_id: id}).then(res => {
            ...
            tbody.innerHTML = rows.length ? rows.map(f => `<tr>
                ...
                <td><button class="btn btn-sm" onclick="destroyField(${f.id})">删除</button></td>
            </tr>`).join('') : '<tr><td colspan="8" class="text-muted">暂无字段</td></tr>';
        });
    }

...
namespace App\Api\Admin\Responses\PageTemplate;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'PageTemplateQueryResponse')]
class PageTemplateQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: PageTemplateResponse::class))]
    private array $data;

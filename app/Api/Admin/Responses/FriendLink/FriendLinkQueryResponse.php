...
#[OA\Schema(schema: 'FriendLinkQueryResponse')]
class FriendLinkQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: FriendLinkResponse::class))]
    private array $data;

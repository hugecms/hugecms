...
#[OA\Schema(schema: 'BlockQueryResponse')]
class BlockQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: BlockResponse::class))]
    private array $data;

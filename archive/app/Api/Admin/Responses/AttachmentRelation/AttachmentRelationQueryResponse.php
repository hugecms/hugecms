...
#[OA\Schema(schema: 'AttachmentRelationQueryResponse')]
class AttachmentRelationQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AttachmentRelationResponse::class))]
    private array $data;

...
class BlockEntity implements \JsonSerializable
{
    ...
    public const string getBlockName = 'block_name'; // 区块名称

    public const string getBlockType = 'block_type'; // 区块类型：header/footer/banner/content/sidebar/custom

    public const string getContent = 'content'; // 区块内容（HTML/JSON）

    public const string getCss = 'css'; // 自定义CSS样式

    public const string getJs = 'js'; // 自定义JS脚本

    public const string getIsGlobal = 'is_global'; // 是否全局区块（全站复用）：1是，0否

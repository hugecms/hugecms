...
#[OA\Schema(schema: 'FormSubmissionEntity')]
class FormSubmissionEntity implements \JsonSerializable
{
    use HasSerializableAttributes;

    public const string getId = 'id'; // ID

    public const string getFormId = 'form_id'; // 关联表单模板ID

    public const string getSubmissionData = 'submission_data'; // 用户提交的具体表单数据（JSON）

    public const string getSubmitterIp = 'submitter_ip'; // 提交者IP

    public const string getUserAgent = 'user_agent'; // 提交者UA

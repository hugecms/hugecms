...
namespace App\Api\Admin\Responses\Taxonomy;

use App\Http\Responses\PaginateLinkVo;
use Juling\Foundation\Support\Traits\HasSerializableAttributes;
use OpenApi\Attributes as OA;

#[OA\Schema(schema: 'TaxonomyQueryResponse')]
class TaxonomyQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: TaxonomyResponse::class))]
    private array $data;

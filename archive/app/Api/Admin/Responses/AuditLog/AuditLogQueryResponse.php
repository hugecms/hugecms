...
#[OA\Schema(schema: 'AuditLogQueryResponse')]
class AuditLogQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AuditLogResponse::class))]
    private array $data;

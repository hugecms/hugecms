...
#[OA\Schema(schema: 'CartQueryResponse')]
class CartQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: CartResponse::class))]
    private array $data;

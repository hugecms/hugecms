...
#[OA\Schema(schema: 'AttachmentQueryResponse')]
class AttachmentQueryResponse implements \JsonSerializable
{
    ...
    #[OA\Property(property: 'data', description: '数据列表', type: 'array', items: new OA\Items(ref: AttachmentResponse::class))]
    private array $data;
